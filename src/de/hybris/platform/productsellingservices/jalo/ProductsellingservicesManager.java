...
/**
 * This is the extension manager of the Productsellingservices extension.
 */
public class ProductsellingservicesManager extends GeneratedProductsellingservicesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(ProductsellingservicesManager.class.getName());
	 ...
	 */
	public static ProductsellingservicesManager getInstance()
	{
		return (ProductsellingservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProductsellingservicesConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProductsellingservicesManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProductsellingservicesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProductsellingservicesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProductsellingservicesManager called, current tenant: " + getTenant().getTenantID());
		}
	}
