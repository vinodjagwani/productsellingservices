 ...
 *  
 */
package de.hybris.platform.productsellingservices.hmc;
...
/**
 * Provides necessary meta information about the webshopcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class ProductSellingServicesHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(ProductSellingServicesHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.platform.productsellingservices.hmc.locales";
